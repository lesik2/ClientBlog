...
export  function SpecialPost() {
  return (
    <section className={style.wrapper}>
      ...
      <Image className={style.backImage} height={705} width={949} src='/images/specialPostBack.png' alt='special post'/>
        <div className={style.specialPostWrapper}>
          ...
          <p className={style.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
           sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Ut enim ad minim veniam, 
            quis nostrud exercitation ullamco laboris nisi ut
            aliquip.</p>
          <Link href={ROUTES.aboutUs} className={style.link}>
